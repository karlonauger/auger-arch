      ...
      <footer className="d-flex justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <div className="d-flex align-items-center">
          <ul className="nav justify-content-end list-unstyled d-flex">
            <li className="ms-3">
              <a className="" href="https://www.linkedin.com/in/karlon-auger-09280086/" target="_blank" rel="noopener noreferrer">
            ...
            <li className="ms-3">
              <a className="" href="https://github.com/karlonauger" target="_blank" rel="noopener noreferrer">
            ...
            <li className="ms-3">
              <a className="" href="mailto:karlonauger@gmail.com">
